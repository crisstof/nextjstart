...
export default function Todolist() {
    ...
    //etat pour ajouter la liste des tâches (affichzer la tâche)
...
const [datas, setDatas] = useState<{message: string} | null>(null);
//loading
const [loadingg, setLoading] = useState(true);

let RecupJson = async()=>{7
    await new Promise(resolve => setTimeout(resolve, 2000)); // délai de 2 secondes pour tester le loading
...
return (                                    
    ...
    {
    loadingg?(<p>chargement en cours ....</p>) : (datas?.message)
    }
